...
<section class="hero"><p class="pill">Developer docs</p><h1>Build on cognitive infrastructure.</h1><p class="lead">Use 1db to create persistent memory, semantic relationships, temporal context, and AI-native continuity. The live Kubernetes runtime routes cognition through SAPI into TALA and the daTALAke.</p><p><a class="btn" href="/waitlist">Request access</a> <a class="btn alt" href="/openapi.json">OpenAPI JSON</a></p></section>
...
export function openApiDocument(publicOrigin = 'https://1db.io') {
  return {
    ...
    info: {
      title: '1db API',
      version: '0.2.0',
      description: '1db cognition routes through NodeRunner SAPI into TALA and the daTALAke.'
    },
    ...
    paths: {
      ...
      '/api/v1/cognition/backends': { get: { summary: 'List daTALAke cognition backends.' } },
      '/api/v1/cognition/backends/plan': { get: { summary: 'Plan a cognition operation across backends.' } },
